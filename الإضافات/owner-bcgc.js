...
conn.sendButton(id, `*╔══❰ مطور البوت القياده الخال شخصياً ❱══╗*\n*║*\n*╠❧* ${text}\n*║*\n*╚══════════════╝*`, 'مطور بذكاء من قبل القياده الخال\n' + wm, fs.readFileSync('./src/avatar_contact.png'), [['🤖 المطور 🤖', '.owner'],['💎 المالك 💎', '.donasi']], false, { 
