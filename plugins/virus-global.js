...
if (!text) from = `${m.chat}`;
if (text && isNaN(text)) throw '*[❗تعذر❗]تعذر تشغيل الامر يمكن تشغيل الامر بشكل صحيح*' 
...
await conn.reply(m.chat, `*[❗تعذر ❗] 𝚂يرجى استخدام الامر بشكل صحيح ${command.toUpperCase()} 𝙰 ${send}*`, m, { mentions: [conn.parseMention(send)]})  
}
